...
import SucessSell from './SucessSell';

const ConformPaymentSell = () => {
    const [isConfirmPayment,setIsConfirmPayment]=useState(true);
  return (
    
    <>
    {isConfirmPayment? <div >
        <StepIndicator bankDetails={true} bankDetailsComplete={false} selectCryptoComplete={true} enterAmountComplete={true}/>
        <div >
        ...
        <h1 className='ml-1'>For <br /> Company</h1>
            ...
            <div className='bg-[#F7F7F7] p-6 mt-4 rounded-2xl w-[810]'>
                ...
                <div className='p-2 mt-8'>
                   ...
                   <input type="text" placeholder='Veum Cecilia' className='w-full px-6 py-4 bg-white pr-36 border-2 border-[#E5E5E5] rounded-xl text-xl font-semibold text-gray-900 focus:outline-none focus:border-[#3772FF] transition-colors'/>
                   ...
                   <p className='text-sm'>Reference Code: </p>
                   <div className='bg-white w-full h-12 text-center p-3'>BLUTUKHY34PB</div>
                   <div className='flex justify-between mt-8'>
                     <button onClick={()=>setIsConfirmPayment(true)} className="w-89 h-11   bg-white cursor-pointer  text-black font-bold rounded-full border-1 border-[#353945] text-sm ">
                        Cancel
                      </button> <button onClick={()=>setIsConfirmPayment(!isConfirmPayment)} className="w-89 h-11 bg-red-500 cursor-pointer hover:bg-red-600  text-white font-bold rounded-full shadow-lg transition-colors text-sm ">
                        Continue
                      </button>
                   </div>
                </div>
...
export default ConformPaymentSell