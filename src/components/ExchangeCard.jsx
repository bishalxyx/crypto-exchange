...
import ConformPaymentSell from './ConformPaymentSell';
...
const ExchangeCard = () => {
 ...
 const [isExchange,setIsExchange]=useState(true);
  return (
    <>
    {isExchange?<><StepIndicator enterAmount={true} selectCryptoComplete={true} />
    <div className="p-4 md:p-8 bg-[#F7F7F7] rounded-2xl">
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-7 ">Confirm Information </h2>
              <div className="space-y-6 ">
                ...
                <div className="flex  md:justify-end  pr-16">
                  <button onClick={()=>setIsExchange(!isExchange)} className="w-full md:w-auto px-8 md:px-12 py-3 md:py-4 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-full shadow-lg transition-colors text-sm md:text-base cursor-pointer">
                    Continue
                  </button>
                </div>
              </div>
            </div></>:<ConformPaymentSell/>}
